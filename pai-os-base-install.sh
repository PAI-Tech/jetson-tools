...
AIME_OS_FS_GIT_FOLDER_NAME="$PAI_SYSTEM_FOLDER/PAI-OS-INSTALLER"
...
DUSTYN_JETSON_INFERENCE_GIT_FOLDER_NAME="$PAI_APPS_FOLDER/jetson-inference"
DUSTYN_JETSON_INFERENCE_GIT_LINK="https://github.com/dusty-nv/$DUSTYN_JETSON_INFERENCE_GIT_FOLDER_NAME"
...
pai_install_jetson_inference()
{
	...
	pip3 install ninja
	git -C $PAI_APPS_FOLDER clone -recrusive $DUSTYN_JETSON_INFERENCE_GIT_LINK
	cd $DUSTYN_JETSON_INFERENCE_GIT_FOLDER_NAME
	...
	log "\e[34mJetson Inference installed successfully"
